#!/bin/bash
# Check for pending Antigravity (frontend) tasks
# Run this in Antigravity IDE to see what work is waiting

cd "$(dirname "$0")/.."
echo "🎨 ANTIGRAVITY FRONTEND TASKS"
echo "=============================="
echo ""
...
tasks = data.get('queues', {}).get('antigravity', {}).get('pending', [])
if tasks:
    for t in tasks:
