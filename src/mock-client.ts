...
const DEMO_INVENTORY: InventoryItem[] = [
    // IN_STOCK items
    { id: 'inv-001', sku: 'SKU-GLOVE-L', name: 'Guantes de Látex (L)', quantity: 150, stockCount: 150, unit: 'Caja', reorderLevel: 50, reorderThreshold: 50, expiryDate: '2027-06-30', tenantId: TENANT_ID, status: 'IN_STOCK', createdAt: daysAgo(30), updatedAt: daysAgo(1) },
    { id: 'inv-002', sku: 'SKU-MASK-N95', name: 'Mascarilla N95', quantity: 200, stockCount: 200, unit: 'Unidad', reorderLevel: 100, reorderThreshold: 100, expiryDate: '2028-01-01', tenantId: TENANT_ID, status: 'IN_STOCK', createdAt: daysAgo(45), updatedAt: daysAgo(2) },
    { id: 'inv-003', sku: 'SKU-ALCOHOL', name: 'Alcohol Antiséptico 70%', quantity: 48, stockCount: 48, unit: 'Litro', reorderLevel: 20, reorderThreshold: 20, expiryDate: '2027-12-31', tenantId: TENANT_ID, status: 'IN_STOCK', createdAt: daysAgo(20), updatedAt: daysAgo(3) },
    { id: 'inv-004', sku: 'SKU-GASA-EST', name: 'Gasa Estéril 10x10', quantity: 500, stockCount: 500, unit: 'Paquete', reorderLevel: 200, reorderThreshold: 200, expiryDate: '2028-06-30', tenantId: TENANT_ID, status: 'IN_STOCK', createdAt: daysAgo(60), updatedAt: daysAgo(5) },
    { id: 'inv-005', sku: 'SKU-TENSIOM', name: 'Tensiómetro Digital', quantity: 8, stockCount: 8, unit: 'Unidad', reorderLevel: 3, reorderThreshold: 3, expiryDate: '', tenantId: TENANT_ID, status: 'IN_STOCK', createdAt: daysAgo(90), updatedAt: daysAgo(10) },
    // LOW_STOCK items (for alerts demo)
    { id: 'inv-006', sku: 'SKU-SYR-5ML', name: 'Jeringa 5ml', quantity: 25, stockCount: 25, unit: 'Unidad', reorderLevel: 50, reorderThreshold: 50, expiryDate: '2026-09-30', tenantId: TENANT_ID, status: 'LOW_STOCK', createdAt: daysAgo(30), updatedAt: NOW.toISOString() },
    { id: 'inv-007', sku: 'SKU-SYR-10ML', name: 'Jeringa 10ml', quantity: 18, stockCount: 18, unit: 'Unidad', reorderLevel: 30, reorderThreshold: 30, expiryDate: '2026-08-15', tenantId: TENANT_ID, status: 'LOW_STOCK', createdAt: daysAgo(30), updatedAt: NOW.toISOString() },
    { id: 'inv-008', sku: 'SKU-CATETER', name: 'Catéter IV 22G', quantity: 12, stockCount: 12, unit: 'Unidad', reorderLevel: 25, reorderThreshold: 25, expiryDate: '2026-12-01', tenantId: TENANT_ID, status: 'LOW_STOCK', createdAt: daysAgo(40), updatedAt: NOW.toISOString() },
    { id: 'inv-009', sku: 'SKU-OXIMETRO', name: 'Oxímetro de Pulso', quantity: 2, stockCount: 2, unit: 'Unidad', reorderLevel: 4, reorderThreshold: 4, expiryDate: '', tenantId: TENANT_ID, status: 'LOW_STOCK', createdAt: daysAgo(120), updatedAt: daysAgo(5) },
    // OUT_OF_STOCK items (critical alerts)
    { id: 'inv-010', sku: 'SKU-INSULIN', name: 'Insulina NPH 100UI', quantity: 0, stockCount: 0, unit: 'Frasco', reorderLevel: 10, reorderThreshold: 10, expiryDate: '2026-03-15', tenantId: TENANT_ID, status: 'OUT_OF_STOCK', createdAt: daysAgo(50), updatedAt: NOW.toISOString() },
    { id: 'inv-011', sku: 'SKU-O2-TANK', name: 'Tanque Oxígeno Portátil', quantity: 0, stockCount: 0, unit: 'Unidad', reorderLevel: 3, reorderThreshold: 3, expiryDate: '', tenantId: TENANT_ID, status: 'OUT_OF_STOCK', createdAt: daysAgo(80), updatedAt: NOW.toISOString() },
    // More IN_STOCK
    { id: 'inv-012', sku: 'SKU-VENDA-ELAS', name: 'Venda Elástica 4"', quantity: 75, stockCount: 75, unit: 'Rollo', reorderLevel: 30, reorderThreshold: 30, expiryDate: '2028-12-31', tenantId: TENANT_ID, status: 'IN_STOCK', createdAt: daysAgo(25), updatedAt: daysAgo(7) },
    { id: 'inv-013', sku: 'SKU-TERMOM', name: 'Termómetro Digital', quantity: 12, stockCount: 12, unit: 'Unidad', reorderLevel: 5, reorderThreshold: 5, expiryDate: '', tenantId: TENANT_ID, status: 'IN_STOCK', createdAt: daysAgo(100), updatedAt: daysAgo(15) },
    { id: 'inv-014', sku: 'SKU-GLUCOM', name: 'Glucómetro', quantity: 6, stockCount: 6, unit: 'Unidad', reorderLevel: 3, reorderThreshold: 3, expiryDate: '', tenantId: TENANT_ID, status: 'IN_STOCK', createdAt: daysAgo(70), updatedAt: daysAgo(20) },
    { id: 'inv-015', sku: 'SKU-TIRAS-GLU', name: 'Tiras Reactivas Glucosa', quantity: 300, stockCount: 300, unit: 'Unidad', reorderLevel: 100, reorderThreshold: 100, expiryDate: '2026-11-30', tenantId: TENANT_ID, status: 'IN_STOCK', createdAt: daysAgo(15), updatedAt: daysAgo(3) }
];
