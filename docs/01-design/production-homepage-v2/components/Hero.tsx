...
const Hero: React.FC = () => {
  const stats = [
    { value: 'Q2 2026', label: 'Lanzamiento', sublabel: 'Acceso Anticipado' },
    { value: 'IA', label: 'Powered', sublabel: 'Amazon Bedrock' },
    { value: '100%', label: 'Colombian', sublabel: 'RIPS Compliant' },
    { value: 'Beta', label: 'Program', sublabel: 'Únete Ahora' },
  ];
  ...
  return (
    <section className="relative min-h-screen flex items-center overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        ...
        */}
        <img
          src="https://images.unsplash.com/photo-1581594693702-fbdc51b2763b?w=1920&q=80"
      ...
      <div className="relative z-10 container mx-auto px-4 lg:px-8 pt-32 pb-20">
        <div className="max-w-3xl">
          ...
          <div className="inline-flex items-center space-x-2 bg-white/10 backdrop-blur-sm border border-white/20 rounded-full px-4 py-2 mb-8">
            ...
            <span className="text-sm text-white/90 font-medium">En desarrollo — Lanzamiento Q2 2026 — Únete al programa beta</span>
          </div>
          ...
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-white leading-tight mb-6">
            ...
            Built for Colombian Healthcare
          </h1>
          ...
          <p className="text-xl text-white/80 leading-relaxed mb-10 max-w-2xl">
            ...
            RIPS automático, defensa de glosas, y optimización de equipos. Lanzamiento Q2 2026.
          </p>
